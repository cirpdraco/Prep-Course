...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  // SUMA DE LOS ARGUMENTOS DEL ARRAY / LA LONGITUD DEL ARRAY
  var suma = 0;
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  // var a = String(b)
  var comienzanueve = n.toString();
  if(comienzanueve.charAt (0) === "9" ){
    return true;
  }
  else {
    return false;
...
function continueStatement(numero) {
  ...
  for(var x = 0; x < 10; x++){
    if(x === 5){
      ...
      suma = suma + 2;
      continuarrecorriendo.push(suma);
    }
  }
  return continuarrecorriendo;
}
